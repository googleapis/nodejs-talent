...
export class CompletionClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    this.completionStub = gaxGrpc.createStub(
        opts.fallback ?
          (protos as protobuf.Root).lookupService('google.cloud.talent.v4beta1.Completion') :
          // tslint:disable-next-line no-any
          (protos as any).google.cloud.talent.v4beta1.Completion,
  ...
  completeQuery(
      ...
      Promise<[
        ...
        protosTypes.google.cloud.talent.v4beta1.ICompleteQueryRequest|undefined, {}|undefined
      ]>;
  completeQuery(
      request: protosTypes.google.cloud.talent.v4beta1.ICompleteQueryRequest,
      options: gax.CallOptions,
