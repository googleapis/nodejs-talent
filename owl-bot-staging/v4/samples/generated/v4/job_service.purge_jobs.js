...
function main(parent, filter) {
  // [START jobs_v4_generated_JobService_PurgeJobs_async]
  /**
  ...
  async function callPurgeJobs() {
    ...
    // Run request
    const [operation] = await talentClient.purgeJobs(request);
    const [response] = await operation.promise();
    console.log(response);
  }

  callPurgeJobs();
  // [END jobs_v4_generated_JobService_PurgeJobs_async]
}
