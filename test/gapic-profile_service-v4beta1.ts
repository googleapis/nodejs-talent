...
describe('v4beta1.ProfileServiceClient', () => {
    ...
    describe('listProfiles', () => {
        it('invokes listProfiles without error', done => {
            ...
            const expectedResponse = {};
            // Mock Grpc layer
            client._innerApiCalls.listProfiles = (actualRequest: {}, options: {}, callback: Callback) => {
    ...
    describe('listProfilesStream', () => {
        it('invokes listProfilesStream without error', done => {
            ...
            const stream = client.listProfilesStream(request, {}).on('data', (response: {}) =>{
                assert.deepStrictEqual(response, expectedResponse);
                done();
    ...
    describe('searchProfiles', () => {
        it('invokes searchProfiles without error', done => {
            ...
            const expectedResponse = {};
            // Mock Grpc layer
            client._innerApiCalls.searchProfiles = (actualRequest: {}, options: {}, callback: Callback) => {
                assert.deepStrictEqual(actualRequest, request);
                callback(null, expectedResponse);
            };
    ...
    describe('searchProfilesStream', () => {
        it('invokes searchProfilesStream without error', done => {
            ...
            const stream = client.searchProfilesStream(request, {}).on('data', (response: {}) =>{
                assert.deepStrictEqual(response, expectedResponse);
                done();
            }).on('error', (err: FakeError) => {
                done(err);
