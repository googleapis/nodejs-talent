...
describe('v4.JobServiceClient', () => {
    ...
    describe('purgeJobs', () => {
        it('invokes purgeJobs without error', async () => {
            const client = new jobserviceModule.v4.JobServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.talent.v4.PurgeJobsRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.longrunning.Operation());
            client.innerApiCalls.purgeJobs = stubLongRunningCall(expectedResponse);
            const [operation] = await client.purgeJobs(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.purgeJobs as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes purgeJobs without error using callback', async () => {
            const client = new jobserviceModule.v4.JobServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.longrunning.Operation());
            client.innerApiCalls.purgeJobs = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.purgeJobs(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.talent.v4.IPurgeJobsResponse, protos.google.cloud.talent.v4.IBatchOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.talent.v4.IPurgeJobsResponse, protos.google.cloud.talent.v4.IBatchOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.purgeJobs as SinonStub)
                .getCall(0).calledWith(request, expectedOptions /*, callback defined above */));
        ...
        it('invokes purgeJobs with call error', async () => {
            const client = new jobserviceModule.v4.JobServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.purgeJobs = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.purgeJobs(request), expectedError);
            assert((client.innerApiCalls.purgeJobs as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes purgeJobs with LRO error', async () => {
            const client = new jobserviceModule.v4.JobServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.purgeJobs = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.purgeJobs(request);
            await assert.rejects(operation.promise(), expectedError);
            assert((client.innerApiCalls.purgeJobs as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        ...
        it('invokes checkPurgeJobsProgress without error', async () => {
            const client = new jobserviceModule.v4.JobServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkPurgeJobsProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });

        it('invokes checkPurgeJobsProgress with error', async () => {
            const client = new jobserviceModule.v4.JobServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkPurgeJobsProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
