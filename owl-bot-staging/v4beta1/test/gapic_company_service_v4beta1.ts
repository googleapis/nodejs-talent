...
describe('v4beta1.CompanyServiceClient', () => {
    ...
    describe('createCompany', () => {
        it('invokes createCompany without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('CreateCompanyRequest', ['parent']);
    ...
    describe('getCompany', () => {
        it('invokes getCompany without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetCompanyRequest', ['name']);
    ...
    describe('updateCompany', () => {
        it('invokes updateCompany without error', async () => {
            ...
            request.company ??= {};
            const defaultValue1 =
              getTypeDefaultValue('UpdateCompanyRequest', ['company', 'name']);
    ...
    describe('deleteCompany', () => {
        it('invokes deleteCompany without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DeleteCompanyRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('listCompanies', () => {
        it('invokes listCompanies without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListCompaniesRequest', ['parent']);
            request.parent = defaultValue1;
