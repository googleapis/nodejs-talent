...
describe('v4.TenantServiceClient', () => {
    ...
    describe('createTenant', () => {
        it('invokes createTenant without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('CreateTenantRequest', ['parent']);
    ...
    describe('getTenant', () => {
        it('invokes getTenant without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetTenantRequest', ['name']);
    ...
    describe('updateTenant', () => {
        it('invokes updateTenant without error', async () => {
            ...
            request.tenant ??= {};
            const defaultValue1 =
              getTypeDefaultValue('UpdateTenantRequest', ['tenant', 'name']);
    ...
    describe('deleteTenant', () => {
        it('invokes deleteTenant without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DeleteTenantRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('listTenants', () => {
        it('invokes listTenants without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListTenantsRequest', ['parent']);
            request.parent = defaultValue1;
